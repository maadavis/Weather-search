...
function searchWeather(searchTerm) {
  ...
  function init(serverResult) {
    ...
    weatherHeader.innerText = resultDescription.charAt(0).toUpperCase() + resultDescription.slice(1);

    temperatureElement.innerHTML = Math.floor(serverResult.main.temp) + '&#176';
    windSpeedElement.innerHTML = 'Winds at ' + Math.floor(serverResult.wind.speed) + 'mph';
    cityHeader.innerHTML = serverResult.name;
    humidityElement.innerHTML = 'Humidity levels at ' + serverResult.main.humidity + '%';
